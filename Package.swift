...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ContentsquareModule",
            url: "https://github.com/ContentSquare/CS_iOS_SDK_MOCK/releases/download/4.25.2/ContentsquareModuleSwiftPackage.xcframework.zip",
            checksum: "799c4099db4b055a49db2c8178762a3b2c2f61f4b89d53420b4b19ccd360956e"),
        .binaryTarget(
            name: "ContentsquareErrorAnalysisModule",
            url: "https://github.com/ContentSquare/CS_iOS_SDK_MOCK/releases/download/4.25.2/ContentsquareErrorAnalysisModuleSwiftPackage.xcframework.zip",
