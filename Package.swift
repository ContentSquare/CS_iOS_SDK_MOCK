...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ContentsquareModule",
            url: "https://github.com/ContentSquare/CS_iOS_SDK_MOCK/releases/download/4.26.0/ContentsquareModuleSwiftPackage.xcframework.zip",
            checksum: "b325ed4754106bb0d7eb1d61fb773d47e4f9496a74e6eb6a9a506cf8ba74ac6b"),
        .binaryTarget(
            name: "ContentsquareErrorAnalysisModule",
            url: "https://github.com/ContentSquare/CS_iOS_SDK_MOCK/releases/download/4.26.0/ContentsquareErrorAnalysisModuleSwiftPackage.xcframework.zip",
